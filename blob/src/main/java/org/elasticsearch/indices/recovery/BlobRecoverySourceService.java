 ...
 *
 * This is a copy from {@link org.elasticsearch.indices.recovery.PeerRecoverySourceService} - with a change marked
 * with "CRATE CHANGE"
 */
public class BlobRecoverySourceService extends AbstractComponent implements IndexEventListener {
    ...
    @Inject
    public BlobRecoverySourceService(Settings settings, TransportService transportService, IndicesService indicesService,
    ...
    public void registerHandler() {
        // the main injection point into the recovery is to handle the start recovery request, which will be sent from
        // the target to the source
        transportService.registerRequestHandler(PeerRecoverySourceService.Actions.START_RECOVERY,
            StartRecoveryRequest::new, ThreadPool.Names.GENERIC, new StartRecoveryTransportRequestHandler());
    }
