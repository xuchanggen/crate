...
class GlobalAggregateConsumer implements Consumer {
    ...
    private static Plan globalAggregates(Functions functions,
        ...
        Collect collect = new Collect(collectPhase, TopN.NO_LIMIT, 0, ap.outputs().size(), null);
        ...
        return new Merge(collect, mergePhase, TopN.NO_LIMIT, 0, topNProjection.outputs().size(), null);
    }
